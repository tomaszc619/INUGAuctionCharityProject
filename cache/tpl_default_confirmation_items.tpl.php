...
<?php $_items_count = (isset($this->_tpldata['items'])) ? sizeof($this->_tpldata['items']) : 0;if ($_items_count) {for ($_items_i = 0; $_items_i < $_items_count; ++$_items_i){$_items_val = &$this->_tpldata['items'][$_items_i]; ?>
		<tr align="center" >
			...
			<td align="left"<?php if ($_items_val['B_BOLD']) {  ?> style="font-weight: bold;"<?php } ?>>
                <a href="<?php echo (isset($this->_rootref['SITEURL'])) ? $this->_rootref['SITEURL'] : ''; ?>item.php?id=<?php echo $_items_val['ID']; ?>" class="bigfont"><?php echo $_items_val['TITLE']; echo $_items_val['ID']; ?></a>
				<?php if ($this->_rootref['B_SUBTITLE'] && $_items_val['SUBTITLE'] != ('')) {  ?><p class="smallspan">Retail price; <?php echo $_items_val['SUBTITLE']; ?></p><?php } ?>
				<p><?php echo ((isset($this->_rootref['L_949'])) ? $this->_rootref['L_949'] : ((isset($MSG['949'])) ? $MSG['949'] : '{ L_949 }')); ?> <?php echo $_items_val['CLOSES']; ?></p>

			</td>
            <td>
	                <input type="number" name="biditem_<?php echo $_items_val['ID']; ?>" value="<?php echo $_items_val['BIDVALUE']; ?>" maxlength="8" />
            </td>
            <td>
                <p><?php echo $_items_val['DESCRIPTION']; ?></p>
            </td>
			<td align="center" width="15%">
